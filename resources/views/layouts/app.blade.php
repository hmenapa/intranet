								...
								@foreach($menus[0] as $menu)
									...
									<li class="has-sub @yield('clase-open-documentos-'.$menu->icono_menu.'')  @yield('clase-active-documentos-'.$menu->icono_menu.'')">
										...
										<ul class="sub-menu @yield('clase-active-documentos-'.$menu->icono_menu.'')">
											...
											<li class="@yield('clase-active-procedimientos-'.$menu->icono_menu.'')"><a href="{{route('procedimientosAreas', ['id' => $menu->icono_menu])}}">{{ __('Registro de Vehículos') }}</a></li>

											<li class="@yield('clase-active-procedimientos-'.$menu->icono_menu.'')"><a href="{{route('procedimientosAreas', ['id' => $menu->icono_menu])}}">{{ __('Retiro y Devolucion de Vehículos') }}</a></li>
